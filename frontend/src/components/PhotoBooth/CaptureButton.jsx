...
const CaptureButton = ({ onCapture }) => {
  return (
    ...
    <FaCamera className="h-10 sm:h-12 md:h-16 lg:h-20 xl:h-23 w-auto mr-2" />
      <span className="text-lg sm:text-base md:text-lg lg:text-6xl xl:text-7xl">Tap to Capture</span>
    </button>
  );
};
